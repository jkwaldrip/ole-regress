Feature:  Describe Workbench
  ...
  Scenario:  Find a Bib by Title
    ...
    And I click search
    Then I see the title in the search results
  ...
  Scenario:  Find a Bib by Author
    ...
    And I click search
    Then I see the author in the search results
  ...
  Scenario:  Find a Holdings by Call Number
    ...
    And I click search
    Then I see the call number in the search results
  ...
  Scenario:  Find an Item by Barcode
    ...
    And I click search
    Then I see the barcode in the search results
