...
Feature:  Describe Workbench
  ...
  Scenario:  Find a Bib by Title
    ...
    And I enter the title in the search field
    And I set the search selector to Title
  ...
  Scenario:  Find a Bib by Author
    When I search for a bib record
    And I enter the author in the search field
    And I set the search selector to Author
  ...
  Scenario:  Find a Holdings by Call Number
    ...
    And I enter the call number in the search field
    And I set the search selector to Call Number
    And I click search on the workbench page
  ...
  Scenario:  Find an Item by Barcode
    ...
    And I enter the barcode in the search field
    And I set the search selector to Item Barcode
    And I click search on the workbench page
